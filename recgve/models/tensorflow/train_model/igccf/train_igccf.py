...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("train UIGCCF")

    # Model parameters
    parser.add_argument("--embedding_size", type=int, default=64)
    parser.add_argument("--convolution_depth", type=int, default=1)
    parser.add_argument("--user_profile_dropout", type=float, default=0.0)
    ...
    model = IGCCF(
        ...
        user_profile_dropout=args["user_profile_dropout"],
        top_k=args["top_k"],
    )
